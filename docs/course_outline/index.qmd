...
editor: visual
---
https://github.com/hhsievertsen/applied_econ_with_r
...
This is a comprehensive course based on empirical economics with R aimed at helping researchers to learn not only analysis but with speed, efficiency, reproducibility and sharing objectives.This is designed to introduce [students to focus on research design]{.yellow}, [thinking clearly with data]{.yellow} and learn by practice. **Doing Economics** by CORE exercises in R (pdf/html document generated in R) will be the requirement for research students to get a pass in the course. Emphasis during the eight weeks comprehensive workshop will be
